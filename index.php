        ...
        <div class="container">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Game Ends!</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="php/highscore.php" id="highForm">
                        <div class="form-group">
                            <input type="text" class="form-control" id="playerName" name="name" placeholder="Number of Points">
                            <input type="text" class="form-control" id="playerPoints" name="points">
                        </div>
                        <div class="form-group">
							<button type="submit" class="btn btn-default" id="saveHigh">Save</button>
						 </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button id="modalButton" type="button" class="btn btn-primary">Submit</button>
                </div>
                </div>
            </div>
            </div>
